...
# the below command will exit the script gracefully
...
# if we pass this line without exiting this means the trigger phrase exists
...
echo "::set-output name=TRAILING_COMMENT::"